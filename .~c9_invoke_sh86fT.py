...
def stock():
    ...
    return render_template("stock.html", ticker = ticker, url_passin = url_passin,method = method, news = news, industry = industry, url = url, sa_url_passin=sa_url_passin, ms_url_passin = ms_url_passin, wsj_url_passin = wsj_url_passin, profile=profile, quote=quote)
